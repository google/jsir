 ...
 public:
  ...
  bool MatchAndExplain(
    ...
    return common_impl_.MatchAndExplain(
        ::maldoca::testing::internal_status::GetStatus(actual_value),
        result_listener);
  }
...
class MonoIsOkMatcherImpl : public ::testing::MatcherInterface<T> {
 public:
  ...
  bool MatchAndExplain(T actual_value,
    ...
    return ::maldoca::testing::internal_status::GetStatus(actual_value).ok();
  }
};
...
#define MALDOCA_EXPECT_OK_AND_EQ(lhs, rexpr) \
  EXPECT_THAT(lhs, ::maldoca::testing::IsOkAndHolds(rexpr));
