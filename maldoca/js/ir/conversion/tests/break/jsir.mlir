...
// JSIR-NEXT:     "jsir.while_statement"() ({
...
// JSIR-NEXT:         "jsir.if_statement"(%1) ({
// JSIR-NEXT:           "jsir.break_statement"() : () -> ()
// JSIR-NEXT:         }, {
// JSIR-NEXT:         }) : (!jsir.any) -> ()
// JSIR-NEXT:       }, {
// JSIR-NEXT:       ^bb0:
// JSIR-NEXT:       }) : () -> ()
// JSIR-NEXT:     }) : () -> ()
// JSIR-NEXT:     "jsir.labeled_statement"() <{label = #jsir<identifier <L 15 C 0>, <L 15 C 6>, "label0", 435, 441, 0, "label0">}> ({
// JSIR-NEXT:       "jsir.while_statement"() ({
// JSIR-NEXT:         %0 = "jsir.identifier"() <{name = "a"}> : () -> !jsir.any
// JSIR-NEXT:         "jsir.expr_region_end"(%0) : (!jsir.any) -> ()
// JSIR-NEXT:       }, {
...
// JSIR-NEXT:           %0 = "jsir.identifier"() <{name = "b"}> : () -> !jsir.any
// JSIR-NEXT:           "jsir.expression_statement"(%0) : (!jsir.any) -> ()
// JSIR-NEXT:           "jsir.labeled_statement"() <{label = #jsir<identifier <L 17 C 2>, <L 17 C 8>, "label1", 462, 468, 4, "label1">}> ({
// JSIR-NEXT:             "jsir.while_statement"() ({
...
// JSIR-NEXT:               %1 = "jsir.identifier"() <{name = "c"}> : () -> !jsir.any
// JSIR-NEXT:               "jsir.if_statement"(%1) ({
// JSIR-NEXT:                 "jsir.break_statement"() <{label = #jsir<identifier <L 19 C 12>, <L 19 C 18>, "label0", 503, 509, 5, "label0">}> : () -> ()
// JSIR-NEXT:               }, {
// JSIR-NEXT:               }) : (!jsir.any) -> ()
// JSIR-NEXT:             }) : () -> ()
// JSIR-NEXT:           }) : () -> ()
...
// JSIR-NEXT:       }) : () -> ()
// JSIR-NEXT:     }) : () -> ()
// JSIR-NEXT:     "jsir.labeled_statement"() <{label = #jsir<identifier <L 26 C 0>, <L 26 C 5>, "label", 713, 718, 0, "label">}> ({
// JSIR-NEXT:       "jsir.break_statement"() <{label = #jsir<identifier <L 26 C 13>, <L 26 C 18>, "label", 726, 731, 0, "label">}> : () -> ()
// JSIR-NEXT:     }) : () -> ()
// JSIR-NEXT:   }, {
// JSIR-NEXT:   ^bb0:
// JSIR-NEXT:   }) : () -> ()
