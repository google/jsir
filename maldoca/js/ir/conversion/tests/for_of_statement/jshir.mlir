...
// JSHIR-NEXT:     "jshir.for_of_statement"(%2, %3) <{await = false, left_declaration = #jsir<for_in_of_declaration <L 4 C 5>, <L 4 C 10>, 24, 29, 2, <L 4 C 9>, <L 4 C 10>, 28, 29, 2, "a", 2, None, "let">}> ({
// JSHIR-NEXT:       %6 = "jsir.identifier"() <{name = "c"}> : () -> !jsir.any
// JSHIR-NEXT:       "jsir.expression_statement"(%6) : (!jsir.any) -> ()
// JSHIR-NEXT:     }) : (!jsir.any, !jsir.any) -> ()
