...
// JSIR-NEXT:         "jsir.if_statement"(%0) ({
// JSIR-NEXT:           "jsir.continue_statement"() : () -> ()
// JSIR-NEXT:         }, {
// JSIR-NEXT:         }) : (!jsir.any) -> ()
...
// JSIR-NEXT:       }) : () -> ()
// JSIR-NEXT:     }) : () -> ()
// JSIR-NEXT:     "jsir.labeled_statement"() <{label = #jsir<identifier <L 7 C 0>, <L 7 C 6>, "label0", 43, 49, 0, "label0">}> ({
// JSIR-NEXT:       "jsir.while_statement"() ({
// JSIR-NEXT:         %0 = "jsir.identifier"() <{name = "a"}> : () -> !jsir.any
// JSIR-NEXT:         "jsir.expr_region_end"(%0) : (!jsir.any) -> ()
// JSIR-NEXT:       }, {
...
// JSIR-NEXT:           "jsir.labeled_statement"() <{label = #jsir<identifier <L 9 C 2>, <L 9 C 8>, "label1", 70, 76, 4, "label1">}> ({
// JSIR-NEXT:             "jsir.while_statement"() ({
...
// JSIR-NEXT:                 "jsir.continue_statement"() <{label = #jsir<identifier <L 11 C 15>, <L 11 C 21>, "label0", 114, 120, 5, "label0">}> : () -> ()
// JSIR-NEXT:               }, {
// JSIR-NEXT:               }) : (!jsir.any) -> ()
// JSIR-NEXT:             }) : () -> ()
// JSIR-NEXT:           }) : () -> ()
