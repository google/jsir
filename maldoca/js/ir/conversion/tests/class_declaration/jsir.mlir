...
// JSIR-NEXT:         "jsir.class_property"() <{literal_key = #jsir<identifier <L 2 C 2>, <L 2 C 21>, "property_identifier", 14, 33, 1, "property_identifier">, static_ = false}> ({
// JSIR-NEXT:           %2 = "jsir.numeric_literal"() <{extra = #jsir<numeric_literal_extra "1", 1.000000e+00 : f64>, value = 1.000000e+00 : f64}> : () -> !jsir.any
// JSIR-NEXT:           "jsir.expr_region_end"(%2) : (!jsir.any) -> ()
// JSIR-NEXT:         }) : () -> ()
// JSIR-NEXT:         "jsir.class_private_property"() <{key = #jsir<private_name <L 3 C 2>, <L 3 C 24>, 41, 63, 1, <L 3 C 3>, <L 3 C 24>, "property_private_name", 42, 63, 1, "property_private_name">, static_ = false}> ({
// JSIR-NEXT:           %2 = "jsir.numeric_literal"() <{extra = #jsir<numeric_literal_extra "2", 2.000000e+00 : f64>, value = 2.000000e+00 : f64}> : () -> !jsir.any
// JSIR-NEXT:           "jsir.expr_region_end"(%2) : (!jsir.any) -> ()
// JSIR-NEXT:         }) : () -> ()
// JSIR-NEXT:         "jsir.class_property"() <{literal_key = #jsir<string_literal <L 4 C 2>, <L 4 C 27>, 71, 96, 1, "property_literal_string", "\22property_literal_string\22", "property_literal_string">, static_ = false}> ({
// JSIR-NEXT:           %2 = "jsir.numeric_literal"() <{extra = #jsir<numeric_literal_extra "3", 3.000000e+00 : f64>, value = 3.000000e+00 : f64}> : () -> !jsir.any
// JSIR-NEXT:           "jsir.expr_region_end"(%2) : (!jsir.any) -> ()
// JSIR-NEXT:         }) : () -> ()
// JSIR-NEXT:         "jsir.class_property"() <{literal_key = #jsir<numeric_literal <L 5 C 2>, <L 5 C 5>, 104, 107, 1, 1.000000e+00 : f64, "1.0", 1.000000e+00 : f64>, static_ = false}> ({
// JSIR-NEXT:           %2 = "jsir.numeric_literal"() <{extra = #jsir<numeric_literal_extra "4", 4.000000e+00 : f64>, value = 4.000000e+00 : f64}> : () -> !jsir.any
// JSIR-NEXT:           "jsir.expr_region_end"(%2) : (!jsir.any) -> ()
// JSIR-NEXT:         }) : () -> ()
// JSIR-NEXT:         %0 = "jsir.string_literal"() <{extra = #jsir<string_literal_extra "\22property_computed\22", "property_computed">, value = "property_computed"}> : () -> !jsir.any
// JSIR-NEXT:         "jsir.class_property"(%0) <{static_ = false}> ({
