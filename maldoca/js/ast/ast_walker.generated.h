...
#ifndef MALDOCA_JS_AST_AST_WALKER_GENERATED_H_
#define MALDOCA_JS_AST_AST_WALKER_GENERATED_H_
...
class JsAstWalker : public JsAstVisitor<void> {
 public:
  ...
  void VisitProgram(const JsProgram &program) override {
    ...
    for (const auto &elem : *program.body()) {
      VisitProgramBodyElement(*elem);
    }
    for (const auto &elem : *program.directives()) {
      VisitDirective(*elem);
    }
    if (postorder_callback_) {
  ...
  void VisitBlockStatement(const JsBlockStatement &block_statement) override {
    ...
    for (const auto &elem : *block_statement.body()) {
      VisitStatement(*elem);
    }
    for (const auto &elem : *block_statement.directives()) {
      VisitDirective(*elem);
    }
    if (postorder_callback_) {
  ...
  void VisitSwitchCase(const JsSwitchCase &switch_case) override {
    ...
    for (const auto &elem : *switch_case.consequent()) {
      VisitStatement(*elem);
    }
    if (postorder_callback_) {
  ...
  void VisitSwitchStatement(const JsSwitchStatement &switch_statement) override {
    ...
    for (const auto &elem : *switch_statement.cases()) {
      VisitSwitchCase(*elem);
    }
    if (postorder_callback_) {
  ...
  void VisitVariableDeclaration(const JsVariableDeclaration &variable_declaration) override {
    ...
    for (const auto &elem : *variable_declaration.declarations()) {
      VisitVariableDeclarator(*elem);
    }
    if (postorder_callback_) {
  ...
  void VisitFunctionDeclaration(const JsFunctionDeclaration &function_declaration) override {
    ...
    for (const auto &elem : *function_declaration.params()) {
      VisitPattern(*elem);
    }
  ...
  void VisitArrowFunctionExpression(const JsArrowFunctionExpression &arrow_function_expression) override {
    if (preorder_callback_) {
      preorder_callback_->VisitArrowFunctionExpression(arrow_function_expression);
    }
    if (arrow_function_expression.id().has_value()) {
      VisitIdentifier(*arrow_function_expression.id().value());
    }
    for (const auto &elem : *arrow_function_expression.params()) {
      VisitPattern(*elem);
    }
    ...
    if (postorder_callback_) {
      postorder_callback_->VisitArrowFunctionExpression(arrow_function_expression);
    }
  }
  ...
  void VisitArrayExpression(const JsArrayExpression &array_expression) override {
    ...
    for (const auto &elem : *array_expression.elements()) {
      if (elem.has_value()) {
        const auto &elem_val = elem.value();
        switch (elem_val.index()) {
          case 0:
            VisitExpression(*std::get<0>(elem_val));
            break;
          case 1:
            VisitSpreadElement(*std::get<1>(elem_val));
            break;
          default:
            LOG(FATAL) << "Unreachable code.";
        }
  ...
  void VisitObjectMethod(const JsObjectMethod &object_method) override {
    ...
    for (const auto &elem : *object_method.params()) {
      VisitPattern(*elem);
    }
  ...
  void VisitObjectExpression(const JsObjectExpression &object_expression) override {
    ...
    for (const auto &elem : *object_expression.properties_()) {
      switch (elem.index()) {
        case 0:
          VisitObjectProperty(*std::get<0>(elem));
          break;
        case 1:
          VisitObjectMethod(*std::get<1>(elem));
          break;
        case 2:
          VisitSpreadElement(*std::get<2>(elem));
          break;
        default:
          LOG(FATAL) << "Unreachable code.";
      }
  ...
  void VisitFunctionExpression(const JsFunctionExpression &function_expression) override {
    ...
    for (const auto &elem : *function_expression.params()) {
      VisitPattern(*elem);
    }
  ...
  void VisitOptionalMemberExpression(const JsOptionalMemberExpression &optional_member_expression) override {
    if (preorder_callback_) {
      preorder_callback_->VisitOptionalMemberExpression(optional_member_expression);
    }
    ...
    if (postorder_callback_) {
      postorder_callback_->VisitOptionalMemberExpression(optional_member_expression);
    }
  }
  ...
  void VisitCallExpression(const JsCallExpression &call_expression) override {
    ...
    for (const auto &elem : *call_expression.arguments()) {
      switch (elem.index()) {
        case 0:
          VisitExpression(*std::get<0>(elem));
          break;
        case 1:
          VisitSpreadElement(*std::get<1>(elem));
          break;
        default:
          LOG(FATAL) << "Unreachable code.";
      }
  ...
  void VisitOptionalCallExpression(const JsOptionalCallExpression &optional_call_expression) override {
    ...
    for (const auto &elem : *optional_call_expression.arguments()) {
      switch (elem.index()) {
        case 0:
          VisitExpression(*std::get<0>(elem));
          break;
    ...
    if (postorder_callback_) {
      postorder_callback_->VisitOptionalCallExpression(optional_call_expression);
    }
  }
  ...
  void VisitNewExpression(const JsNewExpression &new_expression) override {
    ...
    for (const auto &elem : *new_expression.arguments()) {
      switch (elem.index()) {
        case 0:
          VisitExpression(*std::get<0>(elem));
          break;
  ...
  void VisitSequenceExpression(const JsSequenceExpression &sequence_expression) override {
    ...
    for (const auto &elem : *sequence_expression.expressions()) {
  ...
  void VisitParenthesizedExpression(const JsParenthesizedExpression &parenthesized_expression) override {
    if (preorder_callback_) {
      preorder_callback_->VisitParenthesizedExpression(parenthesized_expression);
    }
    VisitExpression(*parenthesized_expression.expression());
    if (postorder_callback_) {
      postorder_callback_->VisitParenthesizedExpression(parenthesized_expression);
    }
  }
  ...
  void VisitTemplateLiteral(const JsTemplateLiteral &template_literal) override {
    ...
    for (const auto &elem : *template_literal.quasis()) {
      VisitTemplateElement(*elem);
    }
    for (const auto &elem : *template_literal.expressions()) {
      VisitExpression(*elem);
    }
    if (postorder_callback_) {
  ...
  void VisitTaggedTemplateExpression(const JsTaggedTemplateExpression &tagged_template_expression) override {
    if (preorder_callback_) {
      preorder_callback_->VisitTaggedTemplateExpression(tagged_template_expression);
    }
    VisitExpression(*tagged_template_expression.tag());
    VisitTemplateLiteral(*tagged_template_expression.quasi());
    if (postorder_callback_) {
      postorder_callback_->VisitTaggedTemplateExpression(tagged_template_expression);
    }
  }
  ...
  void VisitObjectPattern(const JsObjectPattern &object_pattern) override {
    ...
    for (const auto &elem : *object_pattern.properties_()) {
      switch (elem.index()) {
        case 0:
          VisitObjectProperty(*std::get<0>(elem));
          break;
        case 1:
          VisitRestElement(*std::get<1>(elem));
          break;
        default:
          LOG(FATAL) << "Unreachable code.";
      }
  ...
  void VisitArrayPattern(const JsArrayPattern &array_pattern) override {
    ...
    for (const auto &elem : *array_pattern.elements()) {
      if (elem.has_value()) {
        VisitPattern(*elem.value());
      }
    }
    if (postorder_callback_) {
  ...
  void VisitClassMethod(const JsClassMethod &class_method) override {
    ...
    for (const auto &elem : *class_method.params()) {
      VisitPattern(*elem);
    }
  ...
  void VisitClassPrivateMethod(const JsClassPrivateMethod &class_private_method) override {
    ...
    for (const auto &elem : *class_private_method.params()) {
      VisitPattern(*elem);
    }
  ...
  void VisitStaticBlock(const JsStaticBlock &static_block) override {
    ...
    for (const auto &elem : *static_block.body()) {
      VisitStatement(*elem);
    }
    if (postorder_callback_) {
  ...
  void VisitClassBody(const JsClassBody &class_body) override {
    ...
    for (const auto &elem : *class_body.body()) {
      switch (elem.index()) {
        case 0:
          VisitClassMethod(*std::get<0>(elem));
          break;
        case 1:
          VisitClassPrivateMethod(*std::get<1>(elem));
          break;
        case 2:
          VisitClassProperty(*std::get<2>(elem));
          break;
        case 3:
          VisitClassPrivateProperty(*std::get<3>(elem));
          break;
        case 4:
          VisitStaticBlock(*std::get<4>(elem));
          break;
        default:
          LOG(FATAL) << "Unreachable code.";
      }
  ...
  void VisitImportDefaultSpecifier(const JsImportDefaultSpecifier &import_default_specifier) override {
    ...
    if (postorder_callback_) {
      postorder_callback_->VisitImportDefaultSpecifier(import_default_specifier);
    }
  }

  void VisitImportNamespaceSpecifier(const JsImportNamespaceSpecifier &import_namespace_specifier) override {
    if (preorder_callback_) {
      preorder_callback_->VisitImportNamespaceSpecifier(import_namespace_specifier);
    }
    VisitIdentifier(*import_namespace_specifier.local());
    if (postorder_callback_) {
      postorder_callback_->VisitImportNamespaceSpecifier(import_namespace_specifier);
    }
  }
  ...
  void VisitImportDeclaration(const JsImportDeclaration &import_declaration) override {
    ...
    for (const auto &elem : *import_declaration.specifiers()) {
      switch (elem.index()) {
        case 0:
          VisitImportSpecifier(*std::get<0>(elem));
          break;
        case 1:
          VisitImportDefaultSpecifier(*std::get<1>(elem));
          break;
        case 2:
          VisitImportNamespaceSpecifier(*std::get<2>(elem));
          break;
        default:
          LOG(FATAL) << "Unreachable code.";
      }
  ...
  void VisitExportSpecifier(const JsExportSpecifier &export_specifier) override {
    ...
    if (export_specifier.local().has_value()) {
      auto local = export_specifier.local().value();
      switch (local.index()) {
        case 0:
          VisitIdentifier(*std::get<0>(local));
          break;
        case 1:
          VisitStringLiteral(*std::get<1>(local));
          break;
        default:
          LOG(FATAL) << "Unreachable code.";
      }
  ...
  void VisitExportNamedDeclaration(const JsExportNamedDeclaration &export_named_declaration) override {
    ...
    for (const auto &elem : *export_named_declaration.specifiers()) {
      VisitExportSpecifier(*elem);
    }
    ...
    if (export_named_declaration.assertions().has_value()) {
      for (const auto &elem : *export_named_declaration.assertions().value()) {
        VisitImportAttribute(*elem);
      }
    }
    if (postorder_callback_) {
      postorder_callback_->VisitExportNamedDeclaration(export_named_declaration);
    }
  }

  void VisitExportDefaultDeclaration(const JsExportDefaultDeclaration &export_default_declaration) override {
    if (preorder_callback_) {
      preorder_callback_->VisitExportDefaultDeclaration(export_default_declaration);
    }
    switch (export_default_declaration.declaration().index()) {
      case 0:
        VisitFunctionDeclaration(*std::get<0>(export_default_declaration.declaration()));
        break;
      case 1:
        VisitClassDeclaration(*std::get<1>(export_default_declaration.declaration()));
        break;
      case 2:
        VisitExpression(*std::get<2>(export_default_declaration.declaration()));
        break;
      default:
        LOG(FATAL) << "Unreachable code.";
    }
    if (postorder_callback_) {
      postorder_callback_->VisitExportDefaultDeclaration(export_default_declaration);
    }
  }
  ...
  void VisitExportAllDeclaration(const JsExportAllDeclaration &export_all_declaration) override {
    ...
    if (export_all_declaration.assertions().has_value()) {
      for (const auto &elem : *export_all_declaration.assertions().value()) {
        VisitImportAttribute(*elem);
      }
    }
    if (postorder_callback_) {
 ...
 private:
  [[maybe_unused]] JsAstVisitor<void> *preorder_callback_;
  [[maybe_unused]] JsAstVisitor<void> *postorder_callback_;
};
...
class MutableJsAstWalker : public MutableJsAstVisitor<void> {
 ...
 private:
  [[maybe_unused]] MutableJsAstVisitor<void> *preorder_callback_;
  [[maybe_unused]] MutableJsAstVisitor<void> *postorder_callback_;
};
...
#endif  // MALDOCA_JS_AST_AST_WALKER_GENERATED_H_
