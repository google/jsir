...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(AstGenTestParam{
        ...
        .expected_ast_to_json_google3_path =
            "maldoca/astgen/test/"
            "typed_lambda/ast_to_json.generated.cc",
        .expected_ast_from_json_google3_path =
            "maldoca/astgen/test/"
            "typed_lambda/ast_from_json.generated.cc",
    }));
