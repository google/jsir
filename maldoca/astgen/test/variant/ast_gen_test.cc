...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(AstGenTestParam{
        .ast_def_google3_path =
            "maldoca/astgen/test/variant/ast_def.textproto",
        .ts_interface_google3_path = "maldoca/astgen/test/"
                                     "variant/ast_ts_interface.generated",
        ...
        .expected_ast_to_json_google3_path =
            "maldoca/astgen/test/"
            "variant/ast_to_json.generated.cc",
        .expected_ast_from_json_google3_path =
            "maldoca/astgen/test/"
            "variant/ast_from_json.generated.cc",
        .expected_ir_tablegen_google3_path =
            "maldoca/astgen/test/"
            "variant/vir_ops.generated.td",
        .expected_ast_to_ir_source_google3_path =
            "maldoca/astgen/test/"
            "variant/conversion/ast_to_vir.generated.cc",
        .expected_ir_to_ast_source_google3_path =
            "maldoca/astgen/test/"
            "variant/conversion/vir_to_ast.generated.cc",
    }));
