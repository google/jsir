...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(AstGenTestParam{
        .ast_def_google3_path =
            "maldoca/astgen/test/list/ast_def.textproto",
        .ts_interface_google3_path = "maldoca/astgen/test/"
                                     "list/ast_ts_interface.generated",
        .cc_namespace = "maldoca",
        .ast_path = "maldoca/astgen/test/list",
        .ir_path = "maldoca/astgen/test/list",
        .expected_ast_header_google3_path =
            "maldoca/astgen/test/list/ast.generated.h",
        .expected_ast_source_google3_path =
            "maldoca/astgen/test/list/ast.generated.cc",
        .expected_ast_to_json_google3_path =
            "maldoca/astgen/test/"
            "list/ast_to_json.generated.cc",
        .expected_ast_from_json_google3_path =
            "maldoca/astgen/test/"
            "list/ast_from_json.generated.cc",
        .expected_ir_tablegen_google3_path =
            "maldoca/astgen/test/"
            "list/liir_ops.generated.td",
        .expected_ast_to_ir_source_google3_path =
            "maldoca/astgen/test/"
            "list/conversion/ast_to_liir.generated.cc",
        .expected_ir_to_ast_source_google3_path =
            "maldoca/astgen/test/"
            "list/conversion/liir_to_ast.generated.cc",
    }));
